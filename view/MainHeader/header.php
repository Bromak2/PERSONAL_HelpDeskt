<header class="site-header">
	    <div class="container-fluid">
	        ...
	        <a href="#" class="site-logo">
	            <img class="hidden-md-down" src="../../public/img/logo-2.png" alt="logo de Smartcredito">
	            ...
	            <div class="site-header-content-in">
	                <div class="site-header-shown">
	                    <div class="dropdown user-menu">
	                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                            <img href="../public/PERSONAL_HelpDeskt/index.php" src="../../public/img/<?php echo $_SESSION["rol_id"]?>.png" alt="">
	                        </button>
	                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
	                            <a class="dropdown-item" href="#"><span class="font-icon glyphicon glyphicon-user"></span>Perfil</a>
	                            <a class="dropdown-item" href="#"><span class="font-icon glyphicon glyphicon-cog"></span>Opciones</a>
					...
					<div class="dropdown dropdown-typical">
						<a href="#" class="dropdown-toggle no-arr">
							...
							<span class="lblcontactonomx"><?php echo $_SESSION["usu_ape"]?></span>
						</a>
					</div>
